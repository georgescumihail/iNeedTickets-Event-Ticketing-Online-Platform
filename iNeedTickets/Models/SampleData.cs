        ...
        public static void Populate(IApplicationBuilder app) {
            ...
            if (!context.events.Any())
            {
                context.events.AddRange(
                    new Event() {name = "Metallica Concert", location = "Arena Nationala", description = "Metallica se intorc in Romania pentru prima data in ultimii 10 ani, pentru un show de proportii", price = 450, category = "Music", date = DateTime.Now.AddDays(15), photoLink= "metallica.jpeg" },
